...
class tst_inspect extends controllerBasicExtend {
   ...
   public function index() {
      ...
      $grid->addColumn('nr_country_number', 'Number', '60px', $f->retTypeInteger(), array("limit" => 3));
      ...
      $this->load->view("tst_inspect_view", $send);
   }
