...
//var controllerName = "country";
    ...
    var dsFormPrCMTjObject = new function () {
        ...
        thisObj.cd_project_comments_answer = <?php echo($cd_project_comments_answer_data); ?>;
...
?>
            ...
            var func;
            var vcontroller;
            func = 'updateComments/' + thisObj.cd_project_model;
...
//this.makeTypeSelection = function(gridname, beforeid, codefield, descfield, list) {
        ...
        this.setCommentsAfterIns = function (recid) {
            w2ui['gridAttachmentComments'].setItem(recid, 'cd_project_comments', thisObj.Form.getItem('cd_project_comments_form'));
            w2ui['gridAttachmentComments'].setItem(recid, 'cd_project_model', thisObj.cd_project_model);
        ...
        this.updateData = function () {
            ...
            $.each(vccx, function (i, v) {
                vnum--;
                vcc.push({cd_project_comments: vdata.recid, cd_human_resource: v.id, ds_human_resource: v.text, recid: vnum});
            });

            vdata.cc = vcc;
            vdata.cd_project_comments_answer = thisObj.cd_project_comments_answer;
            vdata.cd_human_resource = <?php echo($cd_user) ?>;
            vdata.ds_human_resource = '<?php echo($ds_user) ?>';
            vdata.cd_project_model = '<?php echo($cd_project_model) ?>';
        ...
        this.makeScreenInformation = function () {
            ...
            if (thisObj.cd_project_comments_answer != -1) {
...
<div id="divPrjCommentForm" style="max-height: calc(100vh - 40px);" class="" > 
    ...
    <form id="formComment" class="form-horizontal">
        ...
        <div class='row'>
            <div class="hidden">
                <div class="col-sm-2">
                    <input type="text" class="form-control input-sm"   value="<?php echo($recid) ?>" fieldname="cd_project_comments" id="cd_project_comments_form"  mask="PK"  >
                </div>
            </div>
