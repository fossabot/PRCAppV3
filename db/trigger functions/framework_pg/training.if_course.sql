...
CREATE OR REPLACE FUNCTION training.if_course_before()
  RETURNS trigger AS
$BODY$
DECLARE
    v_error_text text;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION training.if_course_before() SET search_path=pg_catalog, public, spec, rfq;

ALTER FUNCTION training.if_course_before() OWNER TO postgres;

/*

        CREATE TRIGGER t_if_course_before
          BEFORE UPDATE OR INSERT OR DELETE
          ON training."COURSE"
          FOR EACH ROW
          EXECUTE PROCEDURE training.if_course_before();
