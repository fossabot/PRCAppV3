...
CREATE OR REPLACE FUNCTION public.if_jobs_before()
  RETURNS trigger AS
$BODY$
DECLARE
    v_error_text text;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.if_jobs_before() SET search_path=pg_catalog, public, spec, rfq;

ALTER FUNCTION public.if_jobs_before() OWNER TO postgres;

/*

        CREATE TRIGGER t_if_jobs_before
          BEFORE UPDATE OR INSERT OR DELETE
          ON public."JOBS"
          FOR EACH ROW
          EXECUTE PROCEDURE public.if_jobs_before();
