...
CREATE OR REPLACE FUNCTION public.if_division_brand()
  RETURNS trigger AS
$BODY$
DECLARE
    v_error_text text;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.if_division_brand() SET search_path=pg_catalog, public, spec;

ALTER FUNCTION public.if_division_brand()
  OWNER TO postgres;
...
CREATE TRIGGER aa_insert_update_delete
    ...
    ON public."DIVISION_BRAND"
    FOR EACH ROW
    EXECUTE PROCEDURE if_division_brand();
