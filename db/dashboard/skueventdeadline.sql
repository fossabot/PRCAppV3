...
CREATE OR REPLACE FUNCTION spec.skueventdeadline
(
...
--    create table IF NOT EXISTS public.tmpProcessStatus
    ...
    from "SHOE_SPECIFICATION" po
    JOIN "SHOE_SKU" po_sku ON ( po_sku.cd_shoe_specification = po.cd_shoe_specification )
    JOIN "SHOE_SKU_PROCESS" po_sku_prc ON ( po_sku_prc.cd_shoe_sku = po_sku.cd_shoe_sku )
