-- View: spec."vCONSTRUCTION_COMPONENT"

-- DROP VIEW spec."vCONSTRUCTION_COMPONENT";

CREATE OR REPLACE VIEW spec."vCONSTRUCTION_COMPONENT" AS 
 SELECT c.cd_construction_component,
    c.cd_construction,
    ...
    a.cd_construction_component_attributes,
   ...
   FROM "CONSTRUCTION_COMPONENT" c
     JOIN "SHOE_LEVEL_X_PRODUCT_COMPONENT" l ON l.cd_shoe_level_x_product_component = c.cd_shoe_level_x_product_component
     LEFT JOIN "CONSTRUCTION_COMPONENT_ATTRIBUTES" a ON a.cd_construction_component = c.cd_construction_component
  ...
  WHERE sl.dt_deactivated IS NULL AND l.dt_deactivated IS NULL AND l.cd_shoe_level = 1;

ALTER TABLE spec."vCONSTRUCTION_COMPONENT"
  OWNER TO postgres;
GRANT ALL ON TABLE spec."vCONSTRUCTION_COMPONENT" TO postgres;
GRANT SELECT ON TABLE spec."vCONSTRUCTION_COMPONENT" TO "mbReport";
GRANT ALL ON TABLE spec."vCONSTRUCTION_COMPONENT" TO devshoesdemorole;
